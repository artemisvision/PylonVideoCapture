...
public class AviWriter
{
    ...
    public Bitmap Open(string fileName, UInt32 frameRate, int width, int height)
    {
        ...
        //Debug.WriteLine("AviWriter"+frameRate_);
        CreateStream();
        SetOptions();
    ...
    private void CreateStream()
    {
        ...
        strhdr.wPriority = 0;
        strhdr.wLanguage = 0;
        //strhdr.dwRate = 0x00196E69;
        strhdr.dwRate = frameRate_;
        strhdr.dwScale = 0x00051615;
        
 //       strhdr.dwScale = 0x00051615;
/*        strhdr.dwRate = 0x00000001;
        strhdr.dwScale = frameRate_; // Frames per Second*/
//        strhdr.dwRate = 0x0000000F; // Frames per Second
        strhdr.dwStart = 0;
        strhdr.dwLength = 0;
        strhdr.dwInitialFrames = 0;
        strhdr.dwSuggestedBufferSize = height_ * stride_;
        strhdr.dwQuality = 0x00000000; //-1;         // Use default
//        strhdr.dwQuality = 0x90000000;
        strhdr.dwSampleSize = 0;
        strhdr.rect_top = 0;
        strhdr.rect_left = 0;
        strhdr.rect_bottom = height_;
        strhdr.rect_right = width_;
/*       strhdr.rect_top = height_;
        strhdr.rect_left = width_;
        strhdr.rect_bottom = 0;
        strhdr.rect_right = 0;*/
...
/*        AVICOMPRESSOPTIONS opts = new AVICOMPRESSOPTIONS();
        ...
        */
        AVICOMPRESSOPTIONS opts = new AVICOMPRESSOPTIONS();
        opts.fccType = 1935960438; //fccType_;
...
//    private UInt32 fccType_  = (UInt32)Avi.mmioStringToFOURCC("vids", 0);
//    private UInt32 fccHandler_ = (UInt32)Avi.mmioStringToFOURCC("CVID", 0);
    private UInt32 fccType_ = 1935960438;  // vids
    private UInt32 fccHandler_ = 541215044;// IV50
    //1145656899;  // CVID
/*    private UInt32 fccType_ = 1935960438;  // vids
